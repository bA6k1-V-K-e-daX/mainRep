...
def main():
    ...
    prompt = "Блин привет жоска хочу найти коня, может людей, и дартс, а может ещё и домик и банан, можешь мне помочь, блинб и может ещё машину какую то или автобус?"
