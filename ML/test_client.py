...
def main():
    ...
    prompt = "Посмотри, пожалуйста, есть ли на фото кот, собака, лошадь, птица, человек, машина, автобус, велосипед, мотоцикл, фрукты, стул, ноутбук, лодка, поезд или кухня."
