...
export default function TryPeeky() {
  return (
    <div className='mx-auto mt-16 mb-16 flex w-full max-w-screen-2xl flex-col justify-between gap-8 lg:mt-24 lg:mb-20 lg:flex-row lg:gap-12'>
      <div className=''>
        <img src='big_logo.png' alt='' className='w-full max-w-xl object-contain' />
      </div>
      <div className='flex w-full flex-col justify-between lg:max-w-2xl'>
        <div>
        ...
        <div>
          <Link to='/registr'>
            <button className='group relative flex w-full items-center justify-between overflow-hidden text-2xl font-light text-white focus:outline-none md:text-3xl lg:text-4xl'>
